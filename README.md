...
Despite covering fewer number of patients, BlueCross, Aetna, and United Healthcare have a significantly higher costs in managing the patients on the hospital service. 

We also observed cost variation amongst theses providers for similar conditions and duration of stay. This suggests a revisit to the exisiting contract for renegotiation as it doesnt meet the cost cutting criteria put in place by the new management.

Secondly, "late middle-aged (53-73y)" patients have the highest cost of admission on the service, further anaylysis suggest a relationship between complex cases such as diabetes and obesity which are prevalent in this age group needing longer hospital stay. As expected, the "Senior(>73y)" age group were majorly admitted into care for arthritis which is prevalent in individuals of that age group. Teenagers(13-19y) accured the least cost of admission as the conditions under consideration are mostly susceotible to adults and elderly.

Thirdly, diabetes and obesity are chronic conditions that require continous and long-term management. This requires regular doctor visits and medications contributing to high cost of management seen in the dataset available. Additionally, it is highly prevalent and  affect a greater proportion of the population. Despite seen as cost intnsive, cancer is seen to have accured the least cost over the time period. This is because cancer treatment is often shprter-term or time limited as opposed to obesity and diabetes which require lifestyle changes and frequent hospital visits.
...
1. Given that individuals aged between 53 and 73 years spend the longer time under secondary care, accuring the highest cost of management, negotaiting an age-specific insurance policy is advised to ensure transparency in dealing with every age groups under the service.
